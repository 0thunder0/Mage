...
def urls_collect(cat_url,cache_txt):
    ...
    #采集所有文章链接
    novel_list=[]
    urls=page_source('#list dd').items()    
    for ur in urls:
        url_cache=ur('a').attr('href')
        url_cache='http://www.xbiquge.la'+url_cache
...
if __name__=='__main__':
    ...
    url_all=[
            'http://www.xbiquge.la/21/21223/',
            'http://www.xbiquge.la/0/844/'
            ]
    cache_txt='cache_biquge.txt'
